...
WHILE NOT WindowShouldClose
    ...
    v.x = 0!: v.y = 0!: v.z = 0!: vs.x = 32!: vs.y = 32!
    DrawPlane v, vs, LIGHTGRAY ' Draw ground
    v.x = -16.0!: v.y = 2.5!: v.z = 0.0!
    DrawCube v, 1.0, 5.0, 32.0, BLUE ' Draw a blue wall
    v.x = 16.0!: v.y = 2.5!: v.z = 0.0!
    DrawCube v, 1.0, 5.0, 32.0, LIME ' Draw a green wall
    v.x = 0.0!: v.y = 2.5!: v.z = 16.0!
    DrawCube v, 32.0, 5.0, 1.0, GOLD ' Draw a yellow wall
