...
$If RAYLIB_BI = UNDEFINED Then
    ...
    ' Some CRT library functions that we need
    ...
    Declare Static Library "raylib"
        ...
        Sub PeekTypeAtOffset (ByVal p As _Unsigned _Offset, Byval o As _Unsigned _Offset, Byval t As _Unsigned _Offset, Byval t_size As _Unsigned _Offset)
        Sub PokeTypeAtOffset (ByVal p As _Unsigned _Offset, Byval o As _Unsigned _Offset, Byval t As _Unsigned _Offset, Byval t_size As _Unsigned _Offset)
